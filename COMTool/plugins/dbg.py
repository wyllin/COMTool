...
'''.format(
    ...
    def onWidgetMain(self, parent):
        ...
        self.sendArea.setFixedHeight(85)
        ...
        sendHistoryWidget = QWidget()
        sendHistoryLayout = QVBoxLayout()
        sendHistoryLayout.setContentsMargins(8, 4, 8, 0)
        sendHistoryWidget.setLayout(sendHistoryLayout)
        sendHistoryLayout.addWidget(self.sendHistory)
        sendWidget = QWidget()
        sendAreaWidgetsLayout = QHBoxLayout()
        sendAreaWidgetsLayout.setContentsMargins(8,4,8,0)
        ...
        self.mainWidget.addWidget(sendHistoryWidget)
        self.mainWidget.setStretchFactor(0, 1)
        self.mainWidget.setStretchFactor(1, 0)
    ...
    def onWidgetSettings(self, parent):
        ...
        serialReceiveSettingsLayout.setContentsMargins(8, 18, 8, 18)
        serialReceiveSettingsLayout.setVerticalSpacing(10)
        ...
        self.receiveSettingsAutoLinefeed = QCheckBox(_("Auto Linefeed"))
        ...
        self.receiveSettingsAutoLinefeedTime.setMaximumWidth(130)
        self.receiveSettingsAutoLinefeedTime.setFixedHeight(31)
        ...
        serialSendSettingsLayout.setContentsMargins(8, 18, 8, 18)
        serialSendSettingsLayout.setVerticalSpacing(10)
        ...
        self.sendSettingsScheduled.setMaximumWidth(130)
        self.sendSettingsScheduled.setFixedHeight(31)
    ...
    def updateReceivedDataDisplay(self, head : str, datas : list, encoding : str, isSend : bool):
        if datas:
            ...
            font = QFont('Microsoft YaHei', self.config["fontSize"])
            format.setFont(font)
